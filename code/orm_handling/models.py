...
class ClassifyUnits(Base):
    ...
    parent_id = Column(Integer, ForeignKey(
        'jobads.id'))  # ClassifyUnits have a parent-child relationship as a child with JobAds.
...
class ExtractionUnits(Base):
    ...
    parent_id = Column(Integer, ForeignKey(
        'classify_units.id'))  # ExtractionUnits have a parent-child relationship as a child with ClassifyUnits.
    parent = relationship('ClassifyUnits', back_populates="children")  # ForeignKey to connect both Classes
    children_extracted = relationship("ExtractedEntity",
                                      back_populates="parent")  # parent-child relationship as a parent
