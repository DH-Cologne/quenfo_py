...
# Paths definieren
input_path = os.path.join('../', 'trainingdata_anonymized.tsv')
output_path = os.path.join('../', 'traindata_sql.db')
...
def transfer_lines_to_df(filelines):
    ...
    for line in filelines:
        # Wenn eine Zeile 2 oder 3 Tabs hat, handelt es sich um die Kopfzeile mit den Informationen: postingID, Zeilennr. und classID
